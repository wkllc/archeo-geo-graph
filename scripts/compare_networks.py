...
with open("data/15_combined.pickle", "rb") as f:
    G_15 = pickle.load(f)

with open("data/16_combined.pickle", "rb") as f:
    G_16 = pickle.load(f)

with open("data/17_combined.pickle", "rb") as f:
    G_17 = pickle.load(f)

with open("data/18_combined.pickle", "rb") as f:
    G_18 = pickle.load(f)

with open("data/19_combined.pickle", "rb") as f:
    G_19 = pickle.load(f)

with open("data/20_combined.pickle", "rb") as f:
    G_20 = pickle.load(f)
